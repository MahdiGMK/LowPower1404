 ...
 *
 * $Id: regs.h,v 1.1.1.1 2000/11/29 14:53:54 cu-cs Exp $
 *
 * $Log: regs.h,v $
...
unsigned int calculateActivity(struct regs_t regs,struct regs_t oldRegs);
unsigned int calculateHammingDistance(md_inst_t regs,md_inst_t oldRegs);
void init_NUM_BITS();
word_t calculateHammingDistanceUsingTable(word_t inst,word_t oldInst);
